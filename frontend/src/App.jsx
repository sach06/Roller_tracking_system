...
import UpdateWSAxleDetails from './pages/UpdateWSAxleDetails';
import UpdateWSAxle from './pages/UpdateWSAxle';
import UpdateWSRoller from './pages/UpdateWSRoller';
import './index.css';
        ...
        <BrowserRouter>
            <Routes>
                ...
                <Route element={<Layout />}>
                    ...
                    <Route path="/update-ws-axle-details/:axleId" element={<UpdateWSAxleDetails />} />
                    <Route path="/update-ws-roller" element={<UpdateWSRoller />} />
                    <Route path="/update-ws-axle" element={<UpdateWSAxle />} />
                </Route>
            </Routes>
        </BrowserRouter>
    );
